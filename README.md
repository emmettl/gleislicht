...
The committed GTFS and boundary snapshots are regenerated with `npm run data:gtfs`, `npm run data:day`, `npm run data:zvv`, `npm run data:zvv:shapes`, `npm run data:geneva`, `npm run data:geneva:shapes`, `npm run data:zurich`, `npm run data:zurich:shapes` and `npm run data:boundary`; see [docs/DATA-PIPELINE.md](./docs/DATA-PIPELINE.md).
