...
Motion Studies 006 now has a non-public adapter proof: `npm run data:london:proof` compiles the official TfL Bakerloo route sequence and weekday timetable into the same compact network contract used by Gleislicht. The committed 25 KiB fixture covers 39 outbound journeys and 25 NaPTAN stations without adding anything to the Swiss page load or selector. See [docs/LONDON.md](./docs/LONDON.md).
