...
Use the **CH / 24H / ZVV / GE / ZH** switch in the search bar to move between Switzerland's rail atlas, its full day, the ZVV region, the Genève/TPG region and Zürich city. All studies share the national coordinate system: selecting a regional or city study physically flies and zooms the camera into the chosen area while a dim national rail layer preserves geographic context, and CH reverses the journey. Reset always returns to the active study's home view. The regional and city artifacts remain separate on-demand downloads, so they do not enlarge the national first load. Zürich tram and bus motion follows official ZVV geometry; Genève tram, trolleybus and bus motion follows official TPG/SITG line geometry. Unmatched services retain honest straight stop interpolation.
...
The planned rural–urban contrast now has a measured counterpart: PostBus route 220 from Reichenbach im Kandertal to Griesalp. Its 20 trips, compact 33-stop bus-and-rail footprint and officially documented 28% final climb make it a strong foil for Zürich's tram pulse and a practical first real-terrain crop. The progressive 24-hour corridor data is committed separately; see [docs/POSTBUS-CORRIDOR.md](./docs/POSTBUS-CORRIDOR.md) for the shortlist and decision.
