...
For a measured journey, search for a Zürich–Chur service such as **2355**, select it, then choose **Descend into real terrain**. The camera follows that train over the matched 116 km corridor while the timetable card and scrubber remain usable. The same scene is available directly through **Corridor study** with the representative IR35 service.
