...
export default function TerritetJourney({network,language,time,onSeek,onFollow,onFinish,onExit}:{network:NetworkSnapshot;language:UiLanguage;time:number;onSeek:(time:number)=>void;onFollow:(id:string|undefined,station:string|undefined)=>void;onFinish:()=>void;onExit:()=>void}){
 ...
 return <section className="journey-card territet-journey" aria-label={copy[direction]} data-phase={phase} data-direction={direction} data-expanded={expanded}>
