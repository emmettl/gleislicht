  ...
  return (
    ...
    >
      ...
      {isNetwork && isTerritet && glionJourneyActive && territetNetwork ? (
        ...
        <Suspense fallback={null}><DetailCard kind="StationCard" snapshot={network} time={networkTime} language={language} onSelectTrain={selectTrain} selectedStation={selectedStation} serviceColors={serviceColors} onConnections={isRigi ? () => setRigiGuideActive(true) : undefined} connectionsLabel={rigiCopy.connections} fullDay={isNationalDay || isRegionalDay || isMountainStudy} frequencyNote={selectionHasHeadwayMotion ? frequencyCopy.mixed : undefined} activeTrainCount={activeTrainCount} movementsLabel={networkStudy === 'national' ? text.trainsInMotion : isJungfrau ? jungfrauCopy?.movements : text.vehiclesInMotion} callWindow={isMountainStudy ? '24h' : isNationalDay ? '3h' : '2h'} numberFormat={numberFormat} text={text} /></Suspense>
