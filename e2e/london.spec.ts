      ...
      await route.fulfill({
        ...
        body: JSON.stringify({
          metadata: {
            ...
            collectedAt: '2099-09-07T07:45:02.000Z',
            scheduledAt: '2099-09-07T07:45:00.000Z',
          ...
          vehicles: [
            {
              ...
              observedAt: '2099-09-07T07:45:00.000Z',
              predictions: [
                {
                  stopId: '940GZZLUGPK',
                  stopName: 'Green Park Underground Station',
                  expectedArrival: '2099-09-07T07:46:00.000Z',
                  secondsToStop: 60,
                },
                {
                  stopId: '940GZZLUOXC',
                  stopName: 'Oxford Circus Underground Station',
                  expectedArrival: '2099-09-07T07:49:00.000Z',
                  secondsToStop: 240,
                },
              ],
            },
