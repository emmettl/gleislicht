...
test('road recordings are discoverable without fetching playback until selected', async ({ page }, info) => {
  ...
  await open.click()
  await dialog.locator('a[href*="recording=horgen-2026-09-08"]').click()
  ...
  await open.click()
  await expect(dialog.locator('a[href*="recording=horgen-2026-09-08"]')).toHaveAttribute('aria-current', 'page')
