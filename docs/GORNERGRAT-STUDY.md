# Gornergrat: dated map, summit ascents and measured terrain
...
This work does not add authored descents or further operating dates. The complete retained day, both directions and short workings remain available on the map. Physical-device review and publication verification remain separate.
...
npx playwright test e2e/gornergrat.spec.ts e2e/gornergrat-terrain.spec.ts e2e/jungfrau-terrain.spec.ts --workers=1
```
...
- `data/gornergrat-terrain-audit.json`: terrain/raster identity, all ascent pattern checks, selected rail features, offsets, station elevations and structure masks.
- `public/data/gornergrat-ascent-terrain.json`: optional 78.0 KiB terrain and railway artifact.
