...
The [seasonal compatibility and release audit](AARGAU-SEASONAL-AUDIT.md) extends validation to twelve dates: **110,050 complete journeys, 1,821,846 calls and 1,146 directed patterns absent from September**. It finds 12 newly active routes and 45 still inactive in the sample. A 460-pattern road extension fills 16,364 seasonal gaps, and 63 exact seasonal border/platform/rail rules fill another 583 occurrences, bringing compatibility to 99.999–100% while preserving every prior path. Only two Brig–Domodossola occurrences remain unresolved. A separate Friday review candidate corrects the line 136 Wittnau branch traversal; 223 of the original 224 flagged directed bus pairs remain under review. The archived September feeds still replay exactly; application release remains pending these reviews.
