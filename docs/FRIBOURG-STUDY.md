...
The entire canton is inventoried against the pinned annual national GTFS: **207 route records, 17 agency identities and all seven districts**, including detached territories and complete out-of-canton journeys. The regional feed admits **2,595 Friday journeys and 1,692 Sunday journeys** with complete source-backed directed stop patterns. This is partial geometry admission, not full service coverage. One route is a provisional geographic member because its sole in-canton platform is within a metre of the boundary; see below.
...
| Admitted scheduled instances | 2,595 | 1,692 |
| Admitted headway instances | 0 | 0 |
| Directed patterns tested | 849 | 588 |
| Complete/admitted directed patterns | 346 | 200 |
| Matched unique directed route/platform pairs | 3,350 / 4,509 (74.3%) | 3,424 / 4,607 (74.3%) |
| Matched scheduled segment occurrences (before whole-pattern exclusion) | 77,103 / 89,328 (86.3%) | 52,891 / 62,231 (85.0%) |
| Matched occurrences including representative headways | 77,103 / 92,072 (83.7%) | 52,891 / 64,495 (82.0%) |
| Segment occurrences retained in admitted complete journeys | 38,769 | 28,544 |
| Carry-in instances / admitted | 97 / 32 | 179 / 52 |
...
116 source records have a route-identity candidate; 76 support at least one admitted journey; 12 have no matched canton-serving route identity.
...
| 834 | Service d'automobiles TPF | 92 | 1,943 / 3,918 | 1,211 / 2,435 |
...
| disconnected-line | 40 / 904 | 27 / 494 |
