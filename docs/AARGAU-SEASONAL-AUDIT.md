...
2. Resolve the remaining witness geometry: 11 rail template occurrences at Waldshut and Bern, and 7,187 bus template occurrences; then extract and independently validate full civil days before extending the release scope.
