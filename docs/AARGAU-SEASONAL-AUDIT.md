...
2. Resolve the remaining witness geometry: 7,187 bus template occurrences across 86 patterns; then extract and independently validate full civil days before extending the release scope.
