...
2. Resolve the remaining witness geometry: 2,108 bus template occurrences across 73 incomplete patterns, including AVA timing/diversion, Schupfart zero-second and Lenzburg stop-distance holds; then extract and independently validate full civil days before extending the release scope.
