...
2. Resolve the remaining witness geometry: 173 rail template occurrences at Waldshut, Bern and Interlaken, and 7,187 bus template occurrences; then extract and independently validate full civil days before extending the release scope.
