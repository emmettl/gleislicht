...
This is the first **2D map** of the composition. Measured Rigi terrain, route elevations, cable behaviour, an authored lake-to-summit sequence, pedestrian connections and source-backed interchange intervals remain open. Vitznau pier/railway and Weggis pier/cableway retain distinct source stops; no walking link or guaranteed connection is invented. Seasonal and weekend selection, validated shipping routes and the other Rigi-area cableways are later increments.
