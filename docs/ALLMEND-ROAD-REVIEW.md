...
Allmendstrasse resumes when the city-network and detector mapping evidence is available. The subsequent [Witikonerstrasse 1101 review](WITIKON-ROAD-REVIEW.md) verifies an exact city-to-canton endpoint connection, but finds no second counter on the reviewed named-road component. No paired recording window is established there.
