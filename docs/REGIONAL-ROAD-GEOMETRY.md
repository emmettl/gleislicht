...
The [subsequent direction review](REGIONAL-ROAD-DIRECTIONS.md) resolves 31 local detector orientations and audits 196 possible same-path station pairs. It uses Zürich detector plans, a Basel named-junction chain and Thurgau's explicit destination labels. Junction and turning-movement checks remain open; counter-to-axis matches and local orientations alone do not justify directional motion along whole corridors.
