...
**Implemented follow-up:** [Luzern cantonal adapter and audit](LUZERN-STUDY.md) inventories 203 route records across 24 agencies using the whole canton polygon. Complete weekday/Sunday calls are validated against cantonal alignments, 700 bus road patterns, 627 federal rail patterns and six federal cableway installations. The regional feeds admit 12,585 Friday and 10,478 Sunday scheduled movement records, including the source’s dense cableway schedules. Every original call is preserved. All 7,374 Friday and 5,250 Sunday bus journeys are now admitted; Two detailed SBB border curves, checked across 45 complete IR75/EC patterns, now complete all 40 IR75 journeys per date through Konstanz. A 79-feature regional shipping census and 45 complete boat patterns add 44 Friday / 54 Sunday lake journeys, including all Hallwilersee fixtures; dock attachments and every shoreline intersection are audited. A dated 56-relation OSM census supplies one explicitly bound Greppen–Meggen segment, completing all six Sunday 3603 journeys while preserving Bahnhofquai platform identity. Como rail termini, Hammetschwand and 42/50 SGV journeys remain excluded. Two separately bound Hochdorf road patterns and a 19-pattern strict access-road supplement preserve context and short platform attachments. A complete 27-feature swissTLM3D ferry census records Rotsee as suspended since April 2025; it supplies no SGV/Hallwilersee course network. Full source snapshots, station/operator crosswalks, source dates, attribution, geometry review panels and reproducible regression checks are included.
...
The entire pinned national GTFS census finds **380 routes across 67 agency identities** with a call in the complete GR canton polygon. Every fixture journey retains all calls, including external termini. The validated initial application scope admits **10,110 Friday / 8,947 Sunday complete instances (including 2,542 representative headways each day)**, using reviewed FOT gauge/operator topology attributed OSM full-pattern bus matching, and nine aerial cableway and four funicular axes. Inactive seasonal records and excluded mountain, boat and other services remain in the denominator.
...
The funicular follow-up admits 213 complete instances per date on Schatzalp, Muottas Muragl and Davos Dorf–Höhenweg. Exact station identities attach within 1.5 m; all twelve previous aerial paths and every earlier journey are unchanged. All six annual funicular routes are audited, including the subsequently reviewed upper Parsenn section and two inactive St. Moritz records. Official seasonal pages and timetable endpoint discrepancies are preserved.

The upper Parsenn review adds 48 complete representative headway instances per date on the complete Höhenweg–Weissfluhjoch axis. One explicit shared-interchange alias connects the original Höhenweg stop to its section-specific federal station over 15.017 m, with a 20 m bound only at that named endpoint. All eighteen earlier mountain paths remain identical. The Samnaun Ravaisch I alternative is retained diagnostically with 45.79/117.08 m attachments; its L2 identity and access connectors remain unapproved and all 34 daily instances excluded.

The upper Chur section adds 962 Friday / 1,022 Sunday complete Känzeli–Brambrüesch source trips on the full federal axis. Its explicit section-station alias attaches over 16.135 m under a 20 m limit only at Känzeli; Brambrüesch remains under 10 m. All twenty earlier mountain paths are unchanged. The archive encodes individual trips every minute, with eight-minute journeys; these counts are preserved source records, not a census of distinct cabins. Original final departures and subsequent arrivals remain intact. Official summer hours agree with the departure envelope without establishing one-minute precision.

Arosa Weisshorn adds 99 complete headway instances per date across all four separate section patterns. Its two federal middle-station records are co-located; the original shared timetable stop attaches over 13.060 m under explicit 20 m middle-stop bounds, while valley and summit remain under 10 m. All twenty-two earlier mountain paths are unchanged. A five-route, fourteen-pattern section survey retains full diagnostic geometry for upper Rothorn, Corvatsch, Weissfluhgipfel and upper Gotschna, documenting their remaining gaps and exclusions. Official seasonal responses and source hashes are preserved; no through journey is invented.
...
**Seasonal follow-up:** The [twelve-date audit](AARGAU-SEASONAL-AUDIT.md) independently verifies 110,050 journeys and 1,821,846 calls, identifies 1,146 directed patterns absent from September and 12 newly active routes, and leaves 45 archived routes inactive in the sample. The [annual witness audit](AARGAU-ANNUAL-WITNESSES.md) now finds active dates for all 45, covered by 19 selected civil dates; their 2,019 archived trip templates introduce 280 directed patterns. A separate exact-template FOT policy adds 3,616 compatible occurrences, and an explicit Interlaken parent/track-group binding adds another 162, preserving every earlier path. A final exact-template Bern platform-50 projection and Waldshut corridor review adds the last 11 rail occurrences, preserving all 3,790 prior paths. All 194 rail patterns now have geometry. The [bus follow-up](AARGAU-WITNESS-BUS-REVIEW.md) inventories all 86 bus patterns and adds 2,466 AVA April occurrences, preserving all 3,801 prior paths. A municipal closure-localization review adds 1,836 September AVA occurrences, preserving all 6,267 earlier paths; the two Uerkenbrücke–Engelplatz directions remain held. Both signed-detour directions also exceed their 120-second source intervals in an optimistic tagged-speed diagnostic. The Schupfart Festival follow-up verifies all 32 trips at 113 advertised calls and adds 195 inferred road occurrences, preserving all 8,103 earlier paths. The May Lenzburg follow-up adds 582 occurrences across eight reviewed directed patterns, preserving all 8,298 earlier paths. Current annual compatibility is 8,880 of 10,988 occurrences. Thirteen bus patterns are complete; 2,108 occurrences across 73 incomplete bus patterns remain, including 161 AVA source-time holds, 153 September closure crossings, twelve Schupfart zero-second intervals and 77 Lenzburg platform-F stop-distance failures. SBB’s 22 April notice supports the May closure corridors; complete calls and calendars remain GTFS evidence. The later EV4 patterns remain excluded. A 460-pattern road extension fills 16,364 prior seasonal gaps, and 63 exact seasonal border/platform/rail rules fill another 583 occurrences, and two exact IC 1303 rules resolve Brig–Domodossola using pinned OSM rail topology and an official station-code association. All twelve samples now have complete geometric compatibility, preserving every prior path. A separate Friday review candidate corrects four occurrences on the evidenced line 136 Wittnau bypass and line 358 Seesteg direct variant; 222 of the original 224 flagged directed bus pairs remain under review. The missing FOT terminal is handled only by those two scoped OSM rail inferences; every original call and platform coordinate stays intact. The archived September feeds and their date-scoped exceptions remain unchanged.

**Next action:** Resolve the 222 remaining source-alignment review pairs and resolve the remaining 2,108 bus template geometry gaps, including AVA timing/diversion, Schupfart zero-second and Lenzburg stop-distance holds, on the newly witnessed routes before expanding release scope. Then integrate reviewed fixtures into the application. The complete route inventory supersedes the representative agency shortlist for Aargau membership.
