...
**Reuse:** The [cantonal dataset catalogue](https://data.tg.ch/api/explore/v2.1/catalog/datasets/netz-des-offentlichen-verkehrs) explicitly declares **CC BY 4.0**. The original declaration and general terms are preserved with source hashes and accompany the feed. Credit: Kanton Thurgau, Abteilung Öffentlicher Verkehr; Amt für Geoinformation. The city and regional road supplements are attributed OpenStreetMap-derived databases under ODbL 1.0. National GTFS and swisstopo boundaries retain their separate terms.

**Implementation follow-up:** The [complete route inventory](THURGAU-ROUTE-INVENTORY.md) covers **132 annual GTFS route records across 15 agency identities and all five districts**, retaining cross-border calls, boats, city networks, night, replacement and inactive services. Directed Friday/Sunday validation admits **3,545 / 1,938 complete journeys** across 84 route records, including 77 full OSM-inferred city patterns for all six Kreuzlingen and ten Frauenfeld fixed routes, plus 296 audited regional road patterns (292 complete) across 59 fixed regional route records. [Regional feed](../public/data/thurgau-region/index.json); [machine-readable audit](../data/thurgau-audit/summary.json). Frauenfeld NT and GTFS type-715 RUB remain excluded as demand-responsive. Four PostAuto patterns at Wittenbach Zentrum lack a positive-length source slice between distinct platform IDs, excluding 37 Friday journeys. Rail and lake gaps remain explicit exclusions. This is a whole-canton inventory with partial geometry admission, not year-round or physical-direction certification.
