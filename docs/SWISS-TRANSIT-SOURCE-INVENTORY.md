...
**Implemented follow-up:** [Luzern cantonal adapter and audit](LUZERN-STUDY.md) now inventories 203 route records across 24 agencies in the pinned archive, using the whole canton polygon. Complete weekday/Sunday source-call patterns are tested against all 114 bus and 29 rail/mountain source alignments. The dated regional feeds admit 8,486 Friday and 6,292 Sunday journeys after five short, explicitly reviewed repairs from exact official donor edges; unresolved patterns, replacement services and lake/mountain gaps remain explicit. This is measured partial motion coverage, not complete cantonal geometry. Raw source snapshots, TU crosswalks, source dates, attribution and reproduction checks are included.
...
**Implementation:** The [Aargau canton audit](AARGAU-STUDY.md) now decodes all 366 line records and inventories all 5,142 national routes against the official canton boundary: 289 archived Aargau-calling routes across 23 agency identities. Friday/Sunday civil-day feeds retain 11,193 / 7,767 complete journeys, including preceding-day carry-in. Directed-pattern geometry covers 92.15% / 88.76% of full-journey segment occurrences, or 96.24% / 92.80% of occurrences touching an Aargau stop. Every source record, admitted route and geometry exclusion is documented; this is not complete geometry coverage or a deployed study.

**Next action:** Resolve night-line identities (171 Sunday journeys currently have no admitted geometry), operator/line mismatches, replacement services and partial source alignments; review running directions and temporary diversions, then validate additional seasonal dates. The complete route inventory supersedes the representative agency shortlist for Aargau membership.
