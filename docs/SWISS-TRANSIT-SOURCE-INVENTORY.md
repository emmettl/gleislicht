...
**Implemented follow-up:** [Luzern cantonal adapter and audit](LUZERN-STUDY.md) inventories 203 route records across 24 agencies in the pinned archive, using the whole canton polygon. Complete weekday/Sunday source-call patterns are tested against all 114 bus and 29 rail/mountain source alignments. The regional feeds admit 8,940 Friday and 6,781 Sunday journeys after five verified official donor-edge repairs and a separately attributed OSM road fallback checked across all 700 complete bus patterns. Bus admission is 7,368/7,374 Friday and 5,249/5,250 Sunday; seven failed or conflicting bus journeys and unresolved rail/lake/mountain patterns remain explicit. This is measured partial cantonal motion coverage. Raw sources, matcher evidence, TU crosswalks, source dates, attribution and reproduction checks are included.
