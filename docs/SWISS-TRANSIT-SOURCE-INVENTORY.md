...
**Implemented follow-up:** [Luzern cantonal adapter and audit](LUZERN-STUDY.md) inventories 203 route records across 24 agencies in the pinned archive, using the whole canton polygon. Complete weekday/Sunday source-call patterns are tested against all 114 bus and 29 rail/mountain source alignments, all 700 bus road patterns and 627 federal rail patterns. The regional feeds admit 9,184 Friday and 7,008 Sunday journeys using reviewed official repairs, attributed OSM road inference and dated FOT rail corridors. Bus admission is 7,368/7,374 Friday and 5,249/5,250 Sunday; rail admission is 1,035/1,059 and 972/1,000. Seven bus journeys, foreign rail termini and lake/mountain gaps remain explicit. Raw sources, matcher and rail evidence, source dates, attribution, regression checks and reproduction instructions are included.
...
**Implementation follow-up:** The [Solothurn cantonal study](SOLOTHURN-STUDY.md) inventories all **193 canton-serving GTFS route records across 19 agency identities and all ten districts**, retaining full cross-canton calls. Its mode-filtered network adapter validates Friday/Sunday directed patterns and emits **3,142 / 2,574** complete geometry movements, including **1,078 / 1,108** representative Weissenstein headway instances. **55 route records** contribute admitted journeys. Exact endpoint/interior source junctions add 419 Friday and 189 Sunday journeys without losing prior admitted patterns; the [topology review](../data/solothurn-audit/topology-review.json) records every connection. The [route inventory](SOLOTHURN-ROUTE-INVENTORY.md) and [machine audit](../data/solothurn-audit/summary.json) retain all exclusions and inactive routes. Night services, unsupported tram/ferry geometry and incomplete patterns are excluded. Geometry is inferred from the official network, not a verified operator itinerary or physical one-way/running-track alignment; two dates do not establish year-round coverage. Original representative agency IDs were survey leads, not the implemented membership denominator.
...
**Implementation:** The [Aargau canton audit](AARGAU-STUDY.md) now decodes all 366 line records and inventories all 5,142 national routes against the official canton boundary: 289 archived Aargau-calling routes across 23 agency identities. Friday/Sunday civil-day feeds retain 11,193 / 7,767 complete journeys, including preceding-day carry-in. AGIS plus explicitly inferred OSM bus and FOT rail geometry covers 99.979% / 99.999% of full-journey segment occurrences, or 99.975% / 100% of occurrences touching an Aargau stop. All Sunday night bus and rail occurrences, Hallwilersee loops, S36 and Rheinfelden bus 7312 now have geometry. Only 37 Friday / one Sunday occurrences remain unresolved at Brugg Aare AG and Bern platforms. FOT catalogue date is July 2021, current validity unconfirmed, with exact operating-point and directed topology evidence. Every prior AGIS/OSM path is regression-preserved. Every source record, admitted route and geometry exclusion is documented; this is not complete geometry coverage or a deployed study.

**Next action:** Review the IR16 Bern and Brugg Aare AG platform attachments without weakening the guards; review running directions and temporary diversions, then validate additional seasonal dates. The complete route inventory supersedes the representative agency shortlist for Aargau membership.
