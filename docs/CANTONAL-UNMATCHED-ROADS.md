...
| **1101 Zürich, Witikonerstrasse** | A city-owned 30051 detailed axis passes through the point; the next feature is 15.70 m away. | The station has 245 complete minutes, but no archived candidate pair. Review city-road scope and continuity before proposing a recording. |
| **1997 Henggart, Weinlandstrasse** | Road 15 passes through the point; a high-speed-road feature is 14.54 m away. | The 4789–1997 diagnostic pair has 104 complete minutes. Establish the competing roads' physical relationship. |
