...
| **2491 Lindau, Lindauerstrasse** | Road 766 crosses beneath the A1 near the point; motorway axes are 14.61 m and 31.21 m away. | The [focused review](LINDAU-2491-ROAD-REVIEW.md) retains the road ambiguity and checks all four Lindau name alternatives. Local destination references remain too close at both 2491 and 1320; partner 1292 also lacks a validated direction pair. Both 104-minute candidates remain unapproved. |
| **3387 Stallikon, Schwandenstrasse** | Road 650 passes through the point; A3 geometry is 6.50 m away horizontally in the tunnel area. | The [focused review](STALLIKON-ROAD-REVIEW.md) retains the road-level ambiguity and identifies Zürich direction failures at both endpoints, plus the intervening ZH 642 roundabout. The 149-minute pair remains unapproved. |
...
All six priority cases in the table now have focused reviews. They establish the evidence still needed before another recording can be admitted; none of these six follow-ups supplies a new usable counter pair. Adliswil 4087's separate scoped direction review remains reusable. Further work on these cases should target the missing station/road-level and directional references, rather than treating their observation windows as approval.
