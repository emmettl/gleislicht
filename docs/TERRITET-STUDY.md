...
The published installation height difference and inclined length do not supply a railway XYZ profile. The separate [measured funicular terrain study](TERRITET-TERRAIN.md) retains two complete swissTLM3D XYZ alternatives and now offers optional standalone terrain playback with a 5 m swissALTI3D landscape. Both loop branches remain context; loop traversal and short rail/ground discrepancies return to the map. Physical cable motion and vehicle branch assignment remain unestablished.
