...
Glion (funi), `ch:1:sloid:30031`, and the Rochers railway’s Glion, `ch:1:sloid:1370`, remain distinct source places. A guaranteed interchange, walking route or through itinerary is not established. Audit those separately before presenting a combined lake-to-summit journey.
