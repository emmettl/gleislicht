...
**Bauma–Wila** adds a sixth recording: 4.8 km of Tösstalstrasse with 104 uninterrupted minutes from 14:14–15:57 CEST, both directions and two mapped junction areas. An explicit destination review resolves Wald ZH against the official road axis while retaining all 25 Wald settlement alternatives and the original ambiguity in the audit.
