...
if (process.argv.includes('--help')) {
  console.log('Usage: node scripts/compile-cantonal-road-study.mjs [--input=recordings/astra-zurich-cantonal] [--topology=data/zurich-cantonal-road-directions.json] [--output=recordings/astra-zurich-cantonal/compiled] [--date=YYYY-MM-DD] [--from=HH:MM] [--to=HH:MM] [--minimum-samples=60]')
  process.exit(0)
}
const timeArg = name => {
