...
describe('Bern display release', () => {
  ...
  describe('invalid display releases', () => {
    ...
    it.each([
      ...
      ['geometry.ic61PlatformsSupplement.source.attribution', d => { d.metadata.geometry.ic61PlatformsSupplement.source.attribution = '' }],
      ['geometry.ic61PlatformsSupplement.documents', d => { d.metadata.geometry.ic61PlatformsSupplement.documents = [] }],
      ['geometry.ic61PlatformsSupplement.policySha256', d => { d.metadata.geometry.ic61PlatformsSupplement.policySha256 = '0'.repeat(64) }],
