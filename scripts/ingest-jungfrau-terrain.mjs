...
export async function ingestMountainTerrain(study, mapRoutes, { columns=193, budgetKiB=220 }={}) {
 ...
 const routes=mapRoutes(network,source,await readJson(`data/${study}-ascent-source.json`))
