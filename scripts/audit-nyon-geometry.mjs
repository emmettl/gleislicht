...
await writeFile(output,JSON.stringify({schemaVersion:1,scope:'NStCM rail plus TPN and Nyon-Prangins buses in the existing Vaud audit. Not an application release; complete source chains, regional boundaries and visual review still require closure.',railSourceSha256:hash(railBytes),railAnchor:'8501060',railSegmentIds:corridor.map(s=>s.id),cacheHashes:Object.fromEntries(cachePaths.map((p,i)=>[p,hash(cacheBytes[i])])),days},null,2)+'\n')
